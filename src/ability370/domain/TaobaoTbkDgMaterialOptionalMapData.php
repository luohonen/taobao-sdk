<?php
namespace Luohonen\TaobaoSdk\Ability370\Domain;
...
class TaobaoTbkDgMaterialOptionalMapData {
    ...
    public function getItemSearchType() : string{
        return $this->item_search_type;
    }

    public function setItemSearchType(string $itemSearchType){
        $this->item_search_type = $itemSearchType;
    }
